...
<header id="header" class="Header" role="banner" >
    <div id="header-contenido-before" class="Header-contenidoBefore">
    ...
    <section id="Header-contenido" class="Header-contenido">
        ...
        <a href="<?php inicio_url(); ?>" id="header-logo" class="Header-logo  animated flipInX">
            <img src="<?php echo get_plantilla_url().'/images/logo2.png'; ?>" alt="<?php bloginfo('name'); ?>">
        </a>
...
<main id="wrappervideo" class="main">