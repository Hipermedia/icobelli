jQuery(document).ready(function($) {
  ...
  $('.MeteoroContact-mapa').mouseleave(function() { 
    ...
    $('#header-contenido-before').toggleClass('tiny', $(document).scrollTop() > 0); 
    $('#Header-contenido').toggleClass('tiny', $(document).scrollTop() > 0); 
	});

  // $("#header").hover(function(){
  //   $("#header-contenido-before").css("height", "auto"); 
  //   }, function(){
  //     $("#header-contenido-before").css("height", "1px"); 
  // });
    ...
    //$('#wrappervideo').tubular({videoId: 'fcbm8SvlRYk'});
});